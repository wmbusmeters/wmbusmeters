...
{"_":"telegram","media":"water","driver":"iporl","name":"Hej","id":"33225544","max_flowwor_m3h":0,"totalitator_m3":123.529,"timestamp":"1111-11-11T11:11:11Z"}
EOF
...
TESTNAME="Test loadable driver wildcard mvt"
TESTRESULT="ERROR"
cat > $TEST/driver.xmq <<EOF
driver {
    name           = iporlwild
...
cat > $TEST/test_expected.txt <<EOF
{"_":"telegram","media":"water","driver":"iporlwild","name":"Hej","id":"33225544","totalitator_m3":123.529,"timestamp":"1111-11-11T11:11:11Z"}
EOF
