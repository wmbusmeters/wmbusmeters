...
if [ "$OUT" != "0.059" ]
then
    printERROR "Test addresses dll failed"
else
    printOK "Test addresses dll"
fi
...
if [ "$OUT" != "0.059" ]
then
    printERROR "Test addresses tpl failed"
else
    printOK "Test addresses tpl"
fi
...
if [ "$OUT" != "0.059" ]
then
    printERROR "Test addresses *.T=07 failed"
else
    printOK "Test addresses *.T=07"
fi
...
if [ "$OUT" != "0.059" ]
then
    printERROR "Test addresses *.T=37 failed"
else
    printOK "Test addresses *.T=37"
fi
