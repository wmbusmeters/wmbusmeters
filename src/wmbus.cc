                              ...
                              string bps)
{
    ...
    {
        if (detectAMB8465AMB3665(&detected, handler) == DeviceAccess::OK)
        {
            return detected;
        }
    }
    ...
    {
        if (detectIM871AIM170A(&detected, handler) == DeviceAccess::OK)
        {
            return detected;
        }
    }
    ...
    {
        if (detectRC1180(&detected, handler) == DeviceAccess::OK)
        {
            return detected;
        }
    }
    ...
    {
        if (detectCUL(&detected, handler) == DeviceAccess::OK)
        {
            return detected;
        }
    }
    ...
    {
        if (detectIU891A(&detected, handler) == DeviceAccess::OK)
        {
            return detected;
        }
    }
