...
X(AMB,MANFCODE('A','M','B'),"Würth Elektronik eiSos, Germany")\
...
X(ART,MANFCODE('A','R','T'),"Electrotécnica Arteche Smart Grid, Spain")\
...
X(ATA,MANFCODE('A','T','A'),"Alcansar Ölçüm ve Otomasyon Sistemleri, Turkey")\
...
X(ATS,MANFCODE('A','T','S'),"Atlas Sayaç Sanayi A Ş, Turkey")\
...
X(BAR,MANFCODE('B','A','R'),"Bär Industrie Elektronik, Germany")\
...
X(BRT,MANFCODE('B','R','T'),"BEREKET TEKNOLOJİK ÖLÇÜM SİSTEMLERİ BİL ELK İNŞ İTH İHR SAN VE TİC ŞTİ, Turkey")\
...
X(BSI,MANFCODE('B','S','I'),"Bundesamt für Sicherheit in der Informationstechnik BSI, Germany")\
X(BSM,MANFCODE('B','S','M'),"Bluestar Electrical Meter Research Institute, China")\
X(BSP,MANFCODE('B','S','P'),"Byucksan Power, South Korea")\
X(BSS,MANFCODE('B','S','S'),"Baylan Su Sayaçları, Turkey")\
X(BST,MANFCODE('B','S','T'),"BESTAS Elektronik Optik, Turkey")\
X(BSX,MANFCODE('B','S','X'),"BS Messtechnik, Germany")\
X(BSY,MANFCODE('B','S','Y'),"Aktif Enerji İnsaat Sanayi ve Ticaret Sirketi, Turkey")\
X(BTA,MANFCODE('B','T','A'),"Buta Elektromekanik A Ş, Turkey")\
...
X(CKT,MANFCODE('C','K','T'),"CKT Elektrik Elektronik Sanayi ve Ticaret A Ş, Turkey")\
...
X(CLS,MANFCODE('C','L','S'),"Celsa Messgeräte, Germany")\
X(CLT,MANFCODE('C','L','T'),"Zhuhai S E Z Calintech Electric, China")\
X(CLX,MANFCODE('C','L','X'),"CLK IPEKYOLU LOJISTIK VE TICARET A Ş, Turkey")\
...
X(DSM,MANFCODE('D','S','M'),"Desimal Elektronik Mühendislik San ve Tic A Ş, Turkey")\
...
X(EES,MANFCODE('E','E','S'),"Eletra Industria e Comercio de Medidores Elétricos, Brazil")\
...
X(EFR,MANFCODE('E','F','R'),"Europäische Funk Rundsteuerung, Germany")\
...
X(EKS,MANFCODE('E','K','S'),"DİCLE KÖK ENERJİ YATIRIM A Ş")\
...
X(ELY,MANFCODE('E','L','Y'),"Elektroniksystem i Umeå, Sweden")\
...
X(EMI,MANFCODE('E','M','I'),"Entorno Inteligente de Medición, Spain")\
...
X(EXT,MANFCODE('E','X','T'),"LOTRIČ Metrology, Slovenia")\
...
X(FLE,MANFCODE('F','L','E'),"XI AN FLAG ELECTRONIC, China")\
...
X(GOT,MANFCODE('G','O','T'),"NetLand Spółka z ograniczoną odpowiedzialnością, Poland")\
X(GPM,MANFCODE('G','P','M'),"Polaris Smart Metering, India")\
X(GPT,MANFCODE('G','P','T'),"GINTAI POWER TECHNOLOGY, China")\
X(GRA,MANFCODE('G','R','A'),"Grässlin, Germany")\
...
X(GRV,MANFCODE('G','R','V'),"Gridventure Arge ve Teknoloji Pazarlama A Ş, Turkey")\
...
X(HMU,MANFCODE('H','M','U'),"Hugo Müller, Germany")\
...
X(IBT,MANFCODE('I','B','T'),"İkom Bilişim Teknolojileri AŞ, Turkey")\
...
X(IKO,MANFCODE('I','K','O'),"İKOM Bilişim Teknolojileri A Ş, Turkey")\
...
X(ISA,MANFCODE('I','S','A'),"Isabellenhütte Heusler, Germany")\
...
X(ITF,MANFCODE('I','T','F'),"ITF Fröschl, Germany")\
...
X(IYI,MANFCODE('I','Y','I'),"KAYI ENERGY Hacettepe Üniversitesi, Turkey")\
...
X(JSO,MANFCODE('J','S','O'),"Schlösser Armaturen, Germany")\
...
X(KAC,MANFCODE('K','A','C'),"АО КАСКАД, Russian Federation")\
...
X(KDN,MANFCODE('K','D','N'),"KADEN VODOMĚRY, Czech Republic")\
...
X(KER,MANFCODE('K','E','R'),"KERMS haftungsbeschränkt, Germany")\
X(KES,MANFCODE('K','E','S'),"Kavosh Electronic Sepahan, Iran")\
X(KEY,MANFCODE('K','E','Y'),"KEYTECH ELEKTRONİK ANONİM ŞİRKETİ, Turkey")\
...
X(KIG,MANFCODE('K','I','G'),"Kiwigrid Kleiststraße, Germany")\
...
X(KUL,MANFCODE('K','U','L'),"Kultura IoT Çözümleri ve Yönetimleri AŞ, Turkey")\
X(KVS,MANFCODE('K','V','S'),"Klepsan Klape Vana ölçü aletleri San Tic Şti, Turkey")\
X(KWH,MANFCODE('K','W','H'),"Zhejiang Songxia Electric Meter, China")\
X(KYN,MANFCODE('K','Y','N'),"Kayon, Poland")\
X(KZK,MANFCODE('K','Z','K'),"KŘIŽÍK, Czech Republic")\
...
X(LGC,MANFCODE('L','G','C'),"Landis Gyr Equipamentos de Mediçãoa Brasil, Brazil")\
...
X(LZG,MANFCODE('L','Z','G'),"Lackmann Zähler Gesellschaft mbH, Germany")\
...
X(MCV,MANFCODE('M','C','V'),"SOCIÉTÉ MAROCAINE DES COMPTEURS SMCV, Morocco")\
...
X(NES,MANFCODE('N','E','S'),"NORA ELK MALZ SAN ve TİC A Ş, Turkey")\
...
X(NZR,MANFCODE('N','Z','R'),"Nordwestdeutsche Zählerrevision Ing Aug Knemeyer, Germany")\
...
X(PTR,MANFCODE('P','T','R'),"Pfiffner Transformatör, Turkey")\
X(PUK,MANFCODE('P','U','K'),"Paktim Consulting UK, United Kingdom")\
X(PUL,MANFCODE('P','U','L'),"NPP Teplovodokhran")\
X(PVT,MANFCODE('P','V','T'),"Pavo Tasarım Üretim Elektronik Tic A Ş, Turkey")\
...
X(RAM,MANFCODE('R','A','M'),"Rossweiner Armaturen und Messgeräte OHG, Germany")\
...
X(SAM,MANFCODE('S','A','M'),"Siemens Österreich AMIS Automated Metering and Information System, Austria")\
...
X(SLP,MANFCODE('S','L','P'),"Sylop spółka z ograniczoną odpowiedzialnością sp k, Poland")\
...
X(SMV,MANFCODE('S','M','V'),"Société Marocaine des Compteurs, Morocco")\
...
X(SYR,MANFCODE('S','Y','R'),"SAYRON GLOBAL ENERJİ A Ş, Turkey")\
...
X(TBS,MANFCODE('T','B','S'),"TEBAŞ END ISI SİS İNŞ TUR SAN VE TİC ŞTİ, Turkey")\
...
X(TEO,MANFCODE('T','E','O'),"ubitricity Gesellschaft für verteilte Energiesysteme mbH, Germany")\
...
X(TKS,MANFCODE('T','K','S'),"Teksan Teknolojik Ölçüm Sistemleri A Ş, Turkey")\
X(TLC,MANFCODE('T','L','C'),"TELECON GALICIA, Spain")\
X(TLM,MANFCODE('T','L','M'),"Theodor Lange Messgeräte, Germany")\
X(TLR,MANFCODE('T','L','R'),"Telereading, Italy")\
X(TLS,MANFCODE('T','L','S'),"TLS Energimätning, Sweden")\
...
X(TMZ,MANFCODE('T','M','Z'),"TMZ Thüringer Mess und Zählerwesen Service, Germany")\
...
X(UBY,MANFCODE('U','B','Y'),"ubitricity Gesellschaft für verteilte Energiesysteme mbH, Germany")\
...
X(VIM,MANFCODE('V','I','M'),"VİEN ENERJİ SİSTEMLERİ SANAYİ VE TİCARET LİMİTED ŞİRKETİ, Turkey")\
...
X(WEG,MANFCODE('W','E','G'),"WEG Equipamentos Elétricos Automação, Brazil")\
...
X(WGN,MANFCODE('W','G','N'),"Wasser Geräte, Germany")\
...
X(WZG,MANFCODE('W','Z','G'),"Neumann Wasserzähler Glaubitz, Germany")\
...
X(ZTX,MANFCODE('Z','T','X'),"ZHEJIANG TANCY INSTRUMENT TECHNOLOGY éTD, China")\
