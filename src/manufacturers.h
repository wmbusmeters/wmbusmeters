...
X(BRT,MANFCODE('B','R','T'),"BEREKET TEKNOLOJAE K A LA A M SAE STEMLERAE BAE L ELK AE NAA AE TH AE HR SAN VE TAE C AA TAE, Turkey")\
...
X(BSS,MANFCODE('B','S','S'),"Baylan Su SayaA larAE, Turkey")\
...
X(EKS,MANFCODE('E','K','S'),"DAE CLE KA K ENERJAE YATIRIM A AA")\
...
X(MSC,MANFCODE('M','S','C'),"TECHSTUDIO Arge ve TasarAE m Sanayi AA TAE, Turkey")\
...
X(NES,MANFCODE('N','E','S'),"NORA ELK MALZ SAN ve TAE C A AA, Turkey")\
...
X(PVT,MANFCODE('P','V','T'),"Pavo TasarAE m A retim Elektronik Tic A AA, Turkey")\
...
X(TBS,MANFCODE('T','B','S'),"TEBAAA END ISI SAE S AE NAA TUR SAN VE TAE C AA TAE, Turkey")\
...
X(VIM,MANFCODE('V','I','M'),"VAE EN ENERJAE SAE STEMLERAE SANAYAE VE TAE CARET LAE MAE TED AA AE RKETAE, Turkey")\
