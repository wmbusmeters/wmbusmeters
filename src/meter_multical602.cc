...
struct MeterMultical602 : public virtual HeatMeter, public virtual MeterCommonImplementation {
...
shared_ptr<HeatMeter> createMultical602(MeterInfo &mi) {
    return shared_ptr<HeatMeter>(new MeterMultical602(mi));
}
