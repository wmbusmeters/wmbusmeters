...
namespace
{
    ...
    void Driver::processContent(Telegram *t)
    {
        ...
        // Current consumption
        uchar curr_lo = content[4];
        uchar curr_me = content[5];
        uchar curr_hi = content[6];
        double curr = (256.0*256.0*curr_hi+256.0*curr_me+curr_lo)/10.0;
...
// { "_":"telegram", "media":"cold water", "meter":"mkradio3a", "name":"", "id":"62560642", "target_m3":1335.3, "total_m3":948.8, "current_date":"2024-11-28T02:00:00Z", "prev_date":"2024-11-28T02:00:00Z", "timestamp":"2024-11-28T09:36:01Z" } 
//
