...
namespace
{
    ...
    static bool ok = registerDriver([](DriverInfo&di)
    {
        ...
        di.addDetection(MANFUCATURER_MAD,  0x06,  0x50);
        di.addDetection(MANUFACTURER_MAD,  0x07,  0x50);
        di.addDetection(MANFUCATURER_MAD,  0x16,  0x50);
